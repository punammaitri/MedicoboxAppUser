...
public class PharmacistSideMenuAdaptor extends RecyclerView.Adapter<PharmacistSideMenuAdaptor.ViewHolder> {
    ...
    public PharmacistSideMenuAdaptor(Context mContext, NavItemClicked navItemClicked, String Titles[], int Icons[]) {
